...
<table>
  <tr>
    ...
    <td align="center"><a href="https://github.com/Amialc"><img src="https://avatars0.githubusercontent.com/u/1114365?v=4" width="100px;" alt="Vladyslav Martynets"/><br /><sub><b>Vladyslav Martynets</b></sub></a><br /><a href="https://github.com/auth0-community/auth0-cycle-samples/commits?author=Amialc" title="Code">💻</a></td>
  </tr>
</table>
...
These samples demonstrate how to add authentication to a Cycle application with Auth0. Each folder contains a distinct application so that various Auth0 features can be viewed in isolation. You can read about these examples in our [Cycle Quickstart](https://auth0.com/docs/quickstart/spa/cyclejs).
