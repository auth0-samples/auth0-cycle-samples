# Auth0 CycleJS Session Handling

This sample demonstrates how to handle session in a Cycle application with Auth0. The sample makes use of Auth0's hosted login page which provides centralized authentication.
